...
class Ball:
	...
	def ball_collision(self, second_ball):
		# TODO
		pass
def get_wall_collisions(number_of_collisions, radius, table_length, table_breadth, cue_ball_x, cue_ball_y, cue_h_prob, cue_h_norm):
	collision_cord = []
	...
	if cue_h_norm and cue_h_prob is not None:
		...
		cue_ball = Ball(cue_stick_x1, cue_stick_y1, radius, "White")
